...
/*     */   
/*     */   public StreamerMode() {
/*  25 */     super("StreamerMode", "Displays client info in a second window.", Module.Category.CLIENT, false, false, false);
/*     */   }
/*     */ 
/*     */   
...
/*  50 */       drawInfo.add("QuartzHack - 0.3.0");
/*  51 */       drawInfo.add("");
...
/*  71 */       drawInfo.add("QuartzHack - 0.3.0");
/*  72 */       drawInfo.add("");
/*  73 */       drawInfo.add("Fps: " + Minecraft.field_71470_ab);
/*  74 */       drawInfo.add("TPS: " + Banzem.serverManager.getTPS());
/*  75 */       drawInfo.add("Ping: " + Banzem.serverManager.getPing() + "ms");
/*  76 */       drawInfo.add("Speed: " + Banzem.speedManager.getSpeedKpH() + "km/h");
...
/*  86 */       String text = Banzem.rotationManager.getDirection4D(false);
/*  87 */       drawInfo.add("");
/*  88 */       drawInfo.add(text);
/*  89 */       drawInfo.add(coordinates);
/*  90 */       drawInfo.add("");
/*  91 */       for (Module module : Banzem.moduleManager.sortedModules) {
/*  92 */         String moduleName = TextUtil.stripColor(module.getFullArrayString());
/*  93 */         drawInfo.add(moduleName);
/*     */       } 
/*  95 */       drawInfo.add("");
/*  96 */       for (PotionEffect effect : Banzem.potionManager.getOwnPotions()) {
/*  97 */         String potionText = TextUtil.stripColor(Banzem.potionManager.getColoredPotionString(effect));
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\modules\client\StreamerMode.class
