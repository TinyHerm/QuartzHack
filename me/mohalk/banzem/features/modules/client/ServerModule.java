...
/*     */   
/*     */   public ServerModule() {
/*  43 */     super("PingBypass", "Manages QuartzHack`s internal Server", Module.Category.CLIENT, false, false, true);
/*  44 */     instance = this;
/*     */   }
/*     */   
...
/*     */   
/*     */   public void onTick() {
/*  88 */     if (Util.mc.func_147114_u() != null && isConnected()) {
/*  89 */       if (((Boolean)this.getName.getValue()).booleanValue()) {
/*  90 */         Util.mc.func_147114_u().func_147297_a((Packet)new CPacketChatMessage("@Servername"));
/*  91 */         this.getName.setValue(Boolean.valueOf(false));
/*     */       } 
/*  93 */       if (this.serverPrefix.equalsIgnoreCase("idk") && mc.field_71441_e != null) {
/*  94 */         Util.mc.func_147114_u().func_147297_a((Packet)new CPacketChatMessage("@Servergetprefix"));
/*     */       }
/*  96 */       if (this.pingTimer.passedMs((((Integer)this.delay.getValue()).intValue() * 1000))) {
/*  97 */         Util.mc.func_147114_u().func_147297_a((Packet)new CPacketKeepAlive(100L));
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\modules\client\ServerModule.class
