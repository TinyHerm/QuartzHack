...
/*    */   
/*    */   public Colors() {
/* 27 */     super("Colors", "Universal colors.", Module.Category.CLIENT, true, false, true);
/* 28 */     INSTANCE = this;
/*    */   }
/*    */ 
/*    */   
...
/* 40 */       Banzem.colorManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), ((Integer)(ClickGui.getInstance()).hoverAlpha.getValue()).intValue());
/*    */     }
/*    */   }
/*    */   
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\modules\client\Colors.class
