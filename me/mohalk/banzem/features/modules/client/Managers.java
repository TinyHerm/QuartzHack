...
/*  16 */   public Setting<String> command = register(new Setting("Command", "QuartzHack.cc"));
/*  17 */   public Setting<Boolean> rainbowPrefix = register(new Setting("RainbowPrefix", Boolean.valueOf(false)));
/*  18 */   public Setting<TextUtil.Color> bracketColor = register(new Setting("BColor", TextUtil.Color.DARK_PURPLE));
/*  19 */   public Setting<TextUtil.Color> commandColor = register(new Setting("CColor", TextUtil.Color.DARK_PURPLE));
...
/*     */   
/*     */   public Managers() {
/*  41 */     super("Management", "ClientManagement", Module.Category.CLIENT, false, false, true);
/*  42 */     setInstance();
/*     */   }
/*     */   
...
/*     */   
/*     */   public void onLoad() {
/*  58 */     Banzem.commandManager.setClientMessage(getCommandMessage());
/*     */   }
/*     */   
/*     */   @SubscribeEvent
...
/*  69 */           Banzem.holeManager.settingChanged();
/*     */         }
/*  71 */         Banzem.commandManager.setClientMessage(getCommandMessage());
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\modules\client\Managers.class
