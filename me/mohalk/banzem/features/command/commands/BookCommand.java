...
/* 41 */       for (int i2 = 0; i2 < 16; i2++) {
/* 42 */         stackName.append("\024\f");
/*    */       }
/* 44 */       heldItem.func_77983_a("author", (NBTBase)new NBTTagString(mc.field_71439_g.func_70005_c_()));
/* 45 */       heldItem.func_77983_a("title", (NBTBase)new NBTTagString(stackName.toString()));
/* 46 */       PacketBuffer buf = new PacketBuffer(Unpooled.buffer());
/* 47 */       buf.func_150788_a(heldItem);
/* 48 */       mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketCustomPayload("MC|BSign", buf));
/* 49 */       sendMessage(Banzem.commandManager.getPrefix() + "Book Hack Success!");
/*    */     } else {
/* 51 */       sendMessage(Banzem.commandManager.getPrefix() + "b1g 3rr0r!");
/*    */     } 
/*    */   }
/*    */ }


/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\command\commands\BookCommand.class
