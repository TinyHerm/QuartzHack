...
/* 21 */       for (Module.Category category : Banzem.moduleManager.getCategories()) {
/* 22 */         String modules = category.getName() + ": ";
/* 23 */         for (Module module1 : Banzem.moduleManager.getModulesByCategory(category)) {
...
/*    */       return;
/*    */     } 
/* 30 */     Module module = Banzem.moduleManager.getModuleByDisplayName(commands[0]);
/* 31 */     if (module == null) {
/* 32 */       module = Banzem.moduleManager.getModuleByName(commands[0]);
/* 33 */       if (module == null) {
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\features\command\commands\ModuleCommand.class
