...
/*     */ import me.mohalk.banzem.features.gui.font.CustomFont;
...
/*  27 */     FontMod cFont = Banzem.moduleManager.<FontMod>getModuleByClass(FontMod.class);
/*     */     try {
...
/*  40 */     if (Banzem.moduleManager.isModuleEnabled(FontMod.class)) {
/*  41 */       if (shadow) {
...
/*  88 */     if (Banzem.moduleManager.isModuleEnabled(FontMod.class)) {
...
/*  95 */     if (Banzem.moduleManager.isModuleEnabled(FontMod.class)) {
/*  96 */       String text = "A";
...
/* Location:              C:\Users\Administrator\Downloads\QuartzHackRewrite-0.3.0-releasee.jar!\me\mohalk\banzem\manager\TextManager.class
