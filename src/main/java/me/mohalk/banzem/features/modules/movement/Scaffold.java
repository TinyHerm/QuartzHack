...
extends Module {
    ...
    public Scaffold() {
        ...
        this.swing = this.register(new Setting<Object>("Swing Arm", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Legit));
    ...
    public void onUpdate() {
        if (this.mode.getValue() == Mode.Legit) {
            if (this.replenishBlocks.getValue().booleanValue() && !(Scaffold.mc.field_71439_g.func_184586_b(EnumHand.MAIN_HAND).func_77973_b() instanceof ItemBlock) && this.getBlockCountHotbar() <= 0) {
                for (int i = 9; i < 45; ++i) {
                    ItemStack is;
                    if (!Scaffold.mc.field_71439_g.field_71069_bz.func_75139_a(i).func_75216_d() || !((is = Scaffold.mc.field_71439_g.field_71069_bz.func_75139_a(i).func_75211_c()).func_77973_b() instanceof ItemBlock) || this.invalid.contains(Block.func_149634_a((Item)is.func_77973_b())) || i >= 36) continue;
            ...
            double y = this.keepY.getValue() != false ? (double)this.lastY : Scaffold.mc.field_71439_g.field_70163_u;
            ...
            if (blockData != null) {
                ...
                if (this.bSwitch.getValue().booleanValue()) {
                    for (int j = 0; j < 9; ++j) {
                        ...
                        if (Scaffold.mc.field_71439_g.field_71071_by.func_70301_a(j).func_190916_E() == 0 || !(Scaffold.mc.field_71439_g.field_71071_by.func_70301_a(j).func_77973_b() instanceof ItemBlock) || this.invalid.contains(((ItemBlock)Scaffold.mc.field_71439_g.field_71071_by.func_70301_a(j).func_77973_b()).func_179223_d())) continue;
    ...
    public double[] getExpandCoords(double x, double z, double forward, double strafe, float YAW) {
        BlockPos underPos = new BlockPos(x, Scaffold.mc.field_71439_g.field_70163_u - (double)(Scaffold.mc.field_71474_y.field_74311_E.func_151470_d() && this.down.getValue() != false ? 2 : 1), z);
        ...
        while (!this.canPlace(underBlock)) {
            ...
            underPos = new BlockPos(xCalc, Scaffold.mc.field_71439_g.field_70163_u - (double)(Scaffold.mc.field_71474_y.field_74311_E.func_151470_d() && this.down.getValue() != false ? 2 : 1), zCalc);
    ...
    private int getBlockCountHotbar() {
        ...
        for (int i = 36; i < 45; ++i) {
            ...
            if (!(is.func_77973_b() instanceof ItemBlock) || this.invalid.contains(((ItemBlock)item).func_179223_d())) continue;
    ...
    private BlockData getBlockData2(BlockPos pos) {
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos.func_177982_a(-1, 0, 0)).func_177230_c())) {
            return new BlockData(pos.func_177982_a(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos.func_177982_a(1, 0, 0)).func_177230_c())) {
            return new BlockData(pos.func_177982_a(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos2.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos2.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos2.func_177982_a(0, 1, 0)).func_177230_c())) {
            return new BlockData(pos2.func_177982_a(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos2.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos2.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos3.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos3.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos3.func_177982_a(0, 1, 0)).func_177230_c())) {
            return new BlockData(pos3.func_177982_a(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos3.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos3.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos4.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos4.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos4.func_177982_a(0, 1, 0)).func_177230_c())) {
            return new BlockData(pos4.func_177982_a(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos4.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos4.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos5.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos5.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos5.func_177982_a(0, 1, 0)).func_177230_c())) {
            return new BlockData(pos5.func_177982_a(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos5.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos5.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos10.func_177982_a(0, -1, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos10.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos10.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos11.func_177982_a(0, -1, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos11.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos11.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos12.func_177982_a(0, -1, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos12.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos12.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos13.func_177982_a(0, -1, 0)).func_177230_c())) {
            return new BlockData(pos13.func_177982_a(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos13.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos13.func_177982_a(0, 0, 1)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos14.func_177982_a(0, -1, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos14.func_177982_a(-1, 0, 0)).func_177230_c())) {
        ...
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos14.func_177982_a(0, 0, 1)).func_177230_c())) {
            return new BlockData(pos14.func_177982_a(0, 0, 1), EnumFacing.NORTH);
        }
        if (!this.invalid.contains(Scaffold.mc.field_71441_e.func_180495_p(pos14.func_177982_a(0, 0, -1)).func_177230_c())) {
            return new BlockData(pos14.func_177982_a(0, 0, -1), EnumFacing.SOUTH);
        }
        return null;
    }
    ...
    public void place(BlockPos posI, EnumFacing face) {
        ...
        if (!Scaffold.mc.field_71439_g.func_70093_af() && BlockUtil.blackList.contains(Scaffold.mc.field_71441_e.func_180495_p(pos).func_177230_c())) {
        ...
        if (Scaffold.mc.field_71474_y.field_74314_A.func_151470_d()) {
            EntityPlayerSP player = Scaffold.mc.field_71439_g;
            player.field_70159_w *= 0.3;
            EntityPlayerSP player2 = Scaffold.mc.field_71439_g;
            player2.field_70179_y *= 0.3;
