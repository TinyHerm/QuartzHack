...
extends Module {
    ...
    public void onUpdate() {
        for (Entity crystal : CrystalScale.mc.field_71441_e.field_72996_f) {
    ...
    public void onReceivePacket(PacketEvent.Receive event) {
        if (event.getPacket() instanceof SPacketDestroyEntities) {
            ...
            for (int id : packet.func_149098_c()) {
                Entity entity = CrystalScale.mc.field_71441_e.func_73045_a(id);
    ...
    public void onRenderModel(RenderEntityModelEvent event) {
        ...
        boolean fancyGraphics = CrystalScale.mc.field_71474_y.field_74347_j;
        CrystalScale.mc.field_71474_y.field_74347_j = false;
        float gamma = CrystalScale.mc.field_71474_y.field_74333_Y;
