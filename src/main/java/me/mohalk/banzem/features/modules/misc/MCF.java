...
extends Module {
    ...
    private void onClick() {
        ...
        if (result != null && result.field_72313_a == RayTraceResult.Type.ENTITY && (entity = result.field_72308_g) instanceof EntityPlayer) {
            if (Banzem.friendManager.isFriend(entity.func_70005_c_())) {
                Banzem.friendManager.removeFriend(entity.func_70005_c_());
                ...
                Banzem.friendManager.addFriend(entity.func_70005_c_());
