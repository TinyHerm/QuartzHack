...
extends Module {
    ...
    public void onUpdate() {
        if (this.window != null) {
            ...
            drawInfo.add("TPS: " + Banzem.serverManager.getTPS());
            drawInfo.add("Ping: " + Banzem.serverManager.getPing() + "ms");
            drawInfo.add("Speed: " + Banzem.speedManager.getSpeedKpH() + "km/h");
            ...
            String text = Banzem.rotationManager.getDirection4D(false);
            drawInfo.add("");
            drawInfo.add(text);
            ...
            for (PotionEffect effect : Banzem.potionManager.getOwnPotions()) {
                String potionText = TextUtil.stripColor(Banzem.potionManager.getColoredPotionString(effect));
