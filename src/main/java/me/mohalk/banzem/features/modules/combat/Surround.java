...
extends Module {
    ...
    public void onEnable() {
        ...
        if (this.center.getValue().booleanValue()) {
            Banzem.positionManager.setPositionPacket((double)this.startPos.func_177958_n() + 0.5, this.startPos.func_177956_o(), (double)this.startPos.func_177952_p() + 0.5, true, true, true);
        }
        this.retries.clear();
    ...
    private void doFeetPlace() {
        ...
        if (!OyVeyentityUtil.isSafe((Entity)Surround.mc.field_71439_g, 0, true)) {
            this.isSafe = 0;
            this.placeBlocks(Surround.mc.field_71439_g.func_174791_d(), OyVeyentityUtil.getUnsafeBlockArray((Entity)Surround.mc.field_71439_g, 0, true), true, false, false);
        } else if (!OyVeyentityUtil.isSafe((Entity)Surround.mc.field_71439_g, -1, false)) {
            this.isSafe = 1;
            this.placeBlocks(Surround.mc.field_71439_g.func_174791_d(), OyVeyentityUtil.getUnsafeBlockArray((Entity)Surround.mc.field_71439_g, -1, false), false, false, true);
        } else {
            this.isSafe = 3;
            if (Util.mc.field_71441_e.func_180495_p(EntityUtil.getRoundedBlockPos((Entity)Util.mc.field_71439_g)).func_177230_c().equals(Blocks.field_150477_bB) && Util.mc.field_71439_g.field_70163_u != (double)EntityUtil.getRoundedBlockPos((Entity)Util.mc.field_71439_g).func_177956_o()) {
                this.placeBlocks(Surround.mc.field_71439_g.func_174791_d(), OyVeyentityUtil.getUnsafeBlockArray((Entity)Surround.mc.field_71439_g, 1, false), false, false, true);
            } else {
                this.isSafe = 4;
            }
    ...
    private Vec3d areClose(Vec3d[] vec3ds) {
        ...
        for (Vec3d vec3d : vec3ds) {
            for (Vec3d pos : OyVeyentityUtil.getUnsafeBlockArray((Entity)Surround.mc.field_71439_g, 0, true)) {
        ...
        block5: for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1: {
                    ...
                    if (Banzem.speedManager.getSpeedKpH() != 0.0 || isExtending || this.extenders >= 1) continue block5;
                    this.placeBlocks(Surround.mc.field_71439_g.func_174791_d().func_178787_e(vec3d), OyVeyentityUtil.getUnsafeBlockArrayFromVec3d(Surround.mc.field_71439_g.func_174791_d().func_178787_e(vec3d), 0, true), hasHelpingBlocks, false, true);
