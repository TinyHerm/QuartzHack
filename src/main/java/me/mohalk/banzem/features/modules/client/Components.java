...
extends Module {
    private static final ResourceLocation box = new ResourceLocation("eralp232/transparent.png");
    public static ResourceLocation logo = new ResourceLocation("eralp232/quartzhack.png");
    ...
    public static EntityPlayer getClosestEnemy() {
        ...
        for (EntityPlayer player : Components.mc.field_71441_e.field_73010_i) {
            if (player == Components.mc.field_71439_g || Banzem.friendManager.isFriend(player)) continue;
    ...
    public void drawTargetHud(float partialTicks) {
        if (this.design.getValue() == TargetHudDesign.NORMAL) {
            ...
            Integer ping = EntityUtil.isFakePlayer(target) ? 0 : (Util.mc.func_147114_u().func_175102_a(target.func_110124_au()) == null ? 0 : Util.mc.func_147114_u().func_175102_a(target.func_110124_au()).func_178853_c());
            ...
            this.renderer.drawStringWithShadow("Pops: " + Banzem.totemPopManager.getTotemPops(target), this.targetHudX.getValue() + 60, this.targetHudY.getValue() + this.renderer.getFontHeight() * 2 + 30, ColorUtil.toRGBA(255, 0, 0, 255));
            GlStateManager.func_179098_w();
            int iteration = 0;
    ...
    public void drawImageLogo() {
        GlStateManager.func_179098_w();
        GlStateManager.func_179084_k();
        Util.mc.func_110434_K().func_110577_a(logo);
        ...
        Util.mc.func_110434_K().func_147645_c(logo);
        GlStateManager.func_179147_l();
        GlStateManager.func_179090_x();
    }
    ...
    public void drawPlayer(EntityPlayer player, int x, int y) {
        ...
        RenderManager rendermanager = Util.mc.func_175598_ae();
    ...
    private void drawBlock(Block block, float x, float y) {
        ...
        Util.mc.func_175599_af().func_180450_b(stack, 0, 0);
