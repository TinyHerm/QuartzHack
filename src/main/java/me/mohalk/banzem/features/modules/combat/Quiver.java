...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (this.stage == 0) {
            ...
            for (int a : this.map) {
                ...
                if ((PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185223_F) || PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185225_H) || PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185224_G)) && this.strSlot == -1) {
                    this.strSlot = a;
                }
                if (!PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185243_o) && !PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185244_p) && !PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185245_q) || this.speedSlot != -1) continue;
                this.speedSlot = a;
            }
            ++this.stage;
    ...
    private ArrayList<Integer> mapArrows() {
        ...
        for (int a = 9; a < 45; ++a) {
            ...
            ItemStack arrow = (ItemStack)Quiver.mc.field_71439_g.field_71069_bz.func_75138_a().get(a);
            if (PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185223_F) || PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185225_H) || PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185224_G)) {
                map.add(a);
            }
            if (!PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185243_o) && !PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185244_p) && !PotionUtils.func_185191_c((ItemStack)arrow).equals(PotionTypes.field_185245_q)) continue;
            map.add(a);
        }
        return map;
    }
