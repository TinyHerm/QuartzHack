...
extends Module {
    private static final ResourceLocation MAP = new ResourceLocation("eralp/transparent.png");
    private static final ResourceLocation SHULKER_GUI_TEXTURE = new ResourceLocation("eralp232/transparent.png");
    ...
    public ToolTips() {
        super("ShulkerPreview", "Several tweaks for tooltips.", Module.Category.MISC, true, false, false);
        this.setInstance();
    }
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        for (EntityPlayer player : ToolTips.mc.field_71441_e.field_73010_i) {
            ...
            } else if (player.func_184614_ca().func_77973_b() instanceof ItemShulkerBox && (playerTimer = this.playerTimers.get(player)) != null) {
                playerTimer.reset();
    ...
    public void renderTooltip(RenderTooltipEvent.PostText event) {
        ...
        if (this.maps.getValue().booleanValue() && !event.getStack().func_190926_b() && event.getStack().func_77973_b() instanceof ItemMap && (mapData = Items.field_151098_aY.func_77873_a(event.getStack(), (World)ToolTips.mc.field_71441_e)) != null) {
            ...
            Util.mc.func_110434_K().func_110577_a(MAP);
    ...
    public void renderShulkerToolTip(ItemStack stack, int x, int y, String name) {
        ...
        if (tagCompound != null && tagCompound.func_150297_b("BlockEntityTag", 10) && (blockEntityTag = tagCompound.func_74775_l("BlockEntityTag")).func_150297_b("Items", 9)) {
            ...
            Util.mc.func_110434_K().func_110577_a(SHULKER_GUI_TEXTURE);
