...
implements Util {
    ...
    public static void attackEntity(Entity entity, boolean packet, boolean swingArm) {
        if (packet) {
            OyVeyentityUtil.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketUseEntity(entity));
        } else {
            OyVeyentityUtil.mc.field_71442_b.func_78764_a((EntityPlayer)OyVeyentityUtil.mc.field_71439_g, entity);
        }
        if (swingArm) {
            OyVeyentityUtil.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
        }
    }
    ...
    public static Vec3d getInterpolatedPos(Entity entity, float partialTicks) {
        return new Vec3d(entity.field_70142_S, entity.field_70137_T, entity.field_70136_U).func_178787_e(OyVeyentityUtil.getInterpolatedAmount(entity, partialTicks));
    }

    public static Vec3d getInterpolatedRenderPos(Entity entity, float partialTicks) {
        return OyVeyentityUtil.getInterpolatedPos(entity, partialTicks).func_178786_a(OyVeyentityUtil.mc.func_175598_ae().field_78725_b, OyVeyentityUtil.mc.func_175598_ae().field_78726_c, OyVeyentityUtil.mc.func_175598_ae().field_78723_d);
    }

    public static Vec3d getInterpolatedRenderPos(Vec3d vec) {
        return new Vec3d(vec.field_72450_a, vec.field_72448_b, vec.field_72449_c).func_178786_a(OyVeyentityUtil.mc.func_175598_ae().field_78725_b, OyVeyentityUtil.mc.func_175598_ae().field_78726_c, OyVeyentityUtil.mc.func_175598_ae().field_78723_d);
    }
    ...
    public static Vec3d getInterpolatedAmount(Entity entity, Vec3d vec) {
        return OyVeyentityUtil.getInterpolatedAmount(entity, vec.field_72450_a, vec.field_72448_b, vec.field_72449_c);
    }

    public static Vec3d getInterpolatedAmount(Entity entity, float partialTicks) {
        return OyVeyentityUtil.getInterpolatedAmount(entity, partialTicks, partialTicks, partialTicks);
    }
    ...
    public static boolean isSafe(Entity entity, int height, boolean floor) {
        return OyVeyentityUtil.getUnsafeBlocks(entity, height, floor).size() == 0;
    }

    public static boolean stopSneaking(boolean isSneaking) {
        if (isSneaking && OyVeyentityUtil.mc.field_71439_g != null) {
            OyVeyentityUtil.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketEntityAction((Entity)OyVeyentityUtil.mc.field_71439_g, CPacketEntityAction.Action.STOP_SNEAKING));
        }
        return false;
    }

    public static boolean isSafe(Entity entity) {
        return OyVeyentityUtil.isSafe(entity, 0, false);
    }
    ...
    public static List<Vec3d> getUnsafeBlocks(Entity entity, int height, boolean floor) {
        return OyVeyentityUtil.getUnsafeBlocksFromVec3d(entity.func_174791_d(), height, floor);
    }
    ...
    public static boolean isMobAggressive(Entity entity) {
        if (entity instanceof EntityPigZombie) {
            ...
            if (entity instanceof EntityWolf) {
                return ((EntityWolf)entity).func_70919_bu() && !OyVeyentityUtil.mc.field_71439_g.equals((Object)((EntityWolf)entity).func_70902_q());
            }
            if (entity instanceof EntityEnderman) {
                return ((EntityEnderman)entity).func_70823_r();
            }
        }
        return OyVeyentityUtil.isHostileMob(entity);
    }
    ...
    public static boolean isFriendlyMob(Entity entity) {
        return entity.isCreatureType(EnumCreatureType.CREATURE, false) && !OyVeyentityUtil.isNeutralMob(entity) || entity.isCreatureType(EnumCreatureType.AMBIENT, false) || entity instanceof EntityVillager || entity instanceof EntityIronGolem || OyVeyentityUtil.isNeutralMob(entity) && !OyVeyentityUtil.isMobAggressive(entity);
    }

    public static boolean isHostileMob(Entity entity) {
        return entity.isCreatureType(EnumCreatureType.MONSTER, false) && !OyVeyentityUtil.isNeutralMob(entity);
    }

    public static List<Vec3d> getUnsafeBlocksFromVec3d(Vec3d pos, int height, boolean floor) {
        ArrayList<Vec3d> vec3ds = new ArrayList<Vec3d>();
        for (Vec3d vector : OyVeyentityUtil.getOffsets(height, floor)) {
            BlockPos targetPos = new BlockPos(pos).func_177963_a(vector.field_72450_a, vector.field_72448_b, vector.field_72449_c);
            Block block = OyVeyentityUtil.mc.field_71441_e.func_180495_p(targetPos).func_177230_c();
    ...
    public static boolean isInHole(Entity entity) {
        return OyVeyentityUtil.isBlockValid(new BlockPos(entity.field_70165_t, entity.field_70163_u, entity.field_70161_v));
    }

    public static boolean isBlockValid(BlockPos blockPos) {
        return OyVeyentityUtil.isBedrockHole(blockPos) || OyVeyentityUtil.isObbyHole(blockPos) || OyVeyentityUtil.isBothHole(blockPos);
    }
    ...
    public static boolean isObbyHole(BlockPos blockPos) {
        ...
        for (BlockPos pos : touchingBlocks) {
            IBlockState touchingState = OyVeyentityUtil.mc.field_71441_e.func_180495_p(pos);
    ...
    public static Vec3d[] getUnsafeBlockArray(Entity entity, int height, boolean floor) {
        List<Vec3d> list = OyVeyentityUtil.getUnsafeBlocks(entity, height, floor);
        Vec3d[] array = new Vec3d[list.size()];
        return list.toArray(array);
    }

    public static Vec3d[] getUnsafeBlockArrayFromVec3d(Vec3d pos, int height, boolean floor) {
        List<Vec3d> list = OyVeyentityUtil.getUnsafeBlocksFromVec3d(pos, height, floor);
        Vec3d[] array = new Vec3d[list.size()];
        return list.toArray(array);
    }

    public static double getDst(Vec3d vec) {
        return OyVeyentityUtil.mc.field_71439_g.func_174791_d().func_72438_d(vec);
    }
    ...
    public static boolean isTrapped(EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop) {
        return OyVeyentityUtil.getUntrappedBlocks(player, antiScaffold, antiStep, legs, platform, antiDrop).size() == 0;
    }
    ...
    public static boolean isTrappedExtended(int extension, EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop, boolean raytrace) {
        return OyVeyentityUtil.getUntrappedBlocksExtended(extension, player, antiScaffold, antiStep, legs, platform, antiDrop, raytrace).size() == 0;
    }
    ...
    public static List<Vec3d> getUntrappedBlocks(EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop) {
        ArrayList<Vec3d> vec3ds = new ArrayList<Vec3d>();
        if (!antiStep && OyVeyentityUtil.getUnsafeBlocks((Entity)player, 2, false).size() == 4) {
            vec3ds.addAll(OyVeyentityUtil.getUnsafeBlocks((Entity)player, 2, false));
        }
        for (int i = 0; i < OyVeyentityUtil.getTrapOffsets(antiScaffold, antiStep, legs, platform, antiDrop).length; ++i) {
            Vec3d vector = OyVeyentityUtil.getTrapOffsets(antiScaffold, antiStep, legs, platform, antiDrop)[i];
    ...
    public static boolean isInWater(Entity entity) {
        ...
        for (int x = MathHelper.func_76128_c((double)entity.field_70165_t); x < MathHelper.func_76143_f((double)entity.field_70165_t); ++x) {
            for (int z = MathHelper.func_76128_c((double)entity.field_70161_v); z < MathHelper.func_76143_f((double)entity.field_70161_v); ++z) {
                ...
                if (!(OyVeyentityUtil.mc.field_71441_e.func_180495_p(pos).func_177230_c() instanceof BlockLiquid)) continue;
                return true;
            }
        }
        return false;
    ...
    public static boolean isDrivenByPlayer(Entity entityIn) {
        return OyVeyentityUtil.mc.field_71439_g != null && entityIn != null && entityIn.equals((Object)OyVeyentityUtil.mc.field_71439_g.func_184187_bx());
    }
    ...
    public static boolean isAboveWater(Entity entity) {
        return OyVeyentityUtil.isAboveWater(entity, false);
    }
    ...
    public static boolean isAboveWater(Entity entity, boolean packet) {
        ...
        double y = entity.field_70163_u - (packet ? 0.03 : (OyVeyentityUtil.isPlayer(entity) ? 0.2 : 0.5));
        for (int x = MathHelper.func_76128_c((double)entity.field_70165_t); x < MathHelper.func_76143_f((double)entity.field_70165_t); ++x) {
            for (int z = MathHelper.func_76128_c((double)entity.field_70161_v); z < MathHelper.func_76143_f((double)entity.field_70161_v); ++z) {
    ...
    public static List<Vec3d> getUntrappedBlocksExtended(int extension, EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop, boolean raytrace) {
        ...
        if (extension == 1) {
            placeTargets.addAll(OyVeyentityUtil.targets(player.func_174791_d(), antiScaffold, antiStep, legs, platform, antiDrop, raytrace));
        } else {
            int extend = 1;
            for (Vec3d vec3d : MathUtil.getBlockBlocks((Entity)player)) {
                if (extend > extension) break;
                placeTargets.addAll(OyVeyentityUtil.targets(vec3d, antiScaffold, antiStep, legs, platform, antiDrop, raytrace));
                ++extend;
            }
        }
    ...
    public static List<Vec3d> targets(Vec3d vec3d, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop, boolean raytrace) {
        ...
        if (antiStep) {
            ...
            List<Vec3d> vec3ds = OyVeyentityUtil.getUnsafeBlocksFromVec3d(vec3d, 2, false);
            if (vec3ds.size() == 4) {
    ...
    public static Vec3d[] getOffsets(int y, boolean floor) {
        List<Vec3d> offsets = OyVeyentityUtil.getOffsetList(y, floor);
    ...
    public static Vec3d[] getTrapOffsets(boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop) {
        List<Vec3d> offsets = OyVeyentityUtil.getTrapOffsetsList(antiScaffold, antiStep, legs, platform, antiDrop);
        Vec3d[] array = new Vec3d[offsets.size()];
        return offsets.toArray(array);
    }
    ...
    public static List<Vec3d> getTrapOffsetsList(boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop) {
        ArrayList<Vec3d> offsets = new ArrayList<Vec3d>(OyVeyentityUtil.getOffsetList(1, false));
        offsets.add(new Vec3d(0.0, 2.0, 0.0));
        if (antiScaffold) {
            offsets.add(new Vec3d(0.0, 3.0, 0.0));
        }
        if (antiStep) {
            offsets.addAll(OyVeyentityUtil.getOffsetList(2, false));
        }
        if (legs) {
            offsets.addAll(OyVeyentityUtil.getOffsetList(0, false));
        }
        if (platform) {
            offsets.addAll(OyVeyentityUtil.getOffsetList(-1, false));
    ...
    public static boolean isAlive(Entity entity) {
        return OyVeyentityUtil.isLiving(entity) && !entity.field_70128_L && ((EntityLivingBase)entity).func_110143_aJ() > 0.0f;
    }

    public static boolean isDead(Entity entity) {
        return !OyVeyentityUtil.isAlive(entity);
    }

    public static float getHealth(Entity entity) {
        if (OyVeyentityUtil.isLiving(entity)) {
    ...
    public static boolean canEntityFeetBeSeen(Entity entityIn) {
        return OyVeyentityUtil.mc.field_71441_e.func_147447_a(new Vec3d(OyVeyentityUtil.mc.field_71439_g.field_70165_t, OyVeyentityUtil.mc.field_71439_g.field_70165_t + (double)OyVeyentityUtil.mc.field_71439_g.func_70047_e(), OyVeyentityUtil.mc.field_71439_g.field_70161_v), new Vec3d(entityIn.field_70165_t, entityIn.field_70163_u, entityIn.field_70161_v), false, true, false) == null;
    }

    public static boolean isntValid(Entity entity, double range) {
        return entity == null || OyVeyentityUtil.isDead(entity) || entity.equals((Object)OyVeyentityUtil.mc.field_71439_g) || entity instanceof EntityPlayer && Banzem.friendManager.isFriend(entity.func_70005_c_()) || OyVeyentityUtil.mc.field_71439_g.func_70068_e(entity) > MathUtil.square(range);
    }

    public static boolean isValid(Entity entity, double range) {
        return !OyVeyentityUtil.isntValid(entity, range);
    }
    ...
    public static double getMaxSpeed() {
        ...
        if (OyVeyentityUtil.mc.field_71439_g.func_70644_a(Objects.requireNonNull(Potion.func_188412_a((int)1)))) {
            maxModifier *= 1.0 + 0.2 * (double)(Objects.requireNonNull(OyVeyentityUtil.mc.field_71439_g.func_70660_b(Objects.requireNonNull(Potion.func_188412_a((int)1)))).func_76458_c() + 1);
        }
        return maxModifier;
    }
    ...
    public static boolean isEntityMoving(Entity entity) {
        ...
        if (entity instanceof EntityPlayer) {
            return OyVeyentityUtil.mc.field_71474_y.field_74351_w.func_151470_d() || OyVeyentityUtil.mc.field_71474_y.field_74368_y.func_151470_d() || OyVeyentityUtil.mc.field_71474_y.field_74370_x.func_151470_d() || OyVeyentityUtil.mc.field_71474_y.field_74366_z.func_151470_d();
        }
    ...
    public static void moveEntityStrafe(double speed, Entity entity) {
        if (entity != null) {
            MovementInput movementInput = OyVeyentityUtil.mc.field_71439_g.field_71158_b;
            double forward = movementInput.field_192832_b;
            double strafe = movementInput.field_78902_a;
            float yaw = OyVeyentityUtil.mc.field_71439_g.field_70177_z;
    ...
    public static boolean rayTraceHitCheck(Entity entity, boolean shouldCheck) {
        return !shouldCheck || OyVeyentityUtil.mc.field_71439_g.func_70685_l(entity);
    }
    ...
    public static Color getColor(Entity entity, int red, int green, int blue, int alpha, boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer && colorFriends && Banzem.friendManager.isFriend((EntityPlayer)entity)) {
    ...
    public static boolean isMoving() {
        return (double)OyVeyentityUtil.mc.field_71439_g.field_191988_bg != 0.0 || (double)OyVeyentityUtil.mc.field_71439_g.field_70702_br != 0.0;
    }

    public static EntityPlayer getClosestEnemy(double distance) {
        EntityPlayer closest = null;
        for (EntityPlayer player : OyVeyentityUtil.mc.field_71441_e.field_73010_i) {
            if (OyVeyentityUtil.isntValid((Entity)player, distance)) continue;
            if (closest == null) {
                closest = player;
                continue;
            }
            if (!(OyVeyentityUtil.mc.field_71439_g.func_70068_e((Entity)player) < OyVeyentityUtil.mc.field_71439_g.func_70068_e((Entity)closest))) continue;
            closest = player;
        }
        return closest;
    }
    ...
    public static boolean checkCollide() {
        if (OyVeyentityUtil.mc.field_71439_g.func_70093_af()) {
            return false;
        }
        if (OyVeyentityUtil.mc.field_71439_g.func_184187_bx() != null && OyVeyentityUtil.mc.field_71439_g.func_184187_bx().field_70143_R >= 3.0f) {
            return false;
        }
        return OyVeyentityUtil.mc.field_71439_g.field_70143_R < 3.0f;
    }

    public static BlockPos getPlayerPosWithEntity() {
        return new BlockPos(OyVeyentityUtil.mc.field_71439_g.func_184187_bx() != null ? OyVeyentityUtil.mc.field_71439_g.func_184187_bx().field_70165_t : OyVeyentityUtil.mc.field_71439_g.field_70165_t, OyVeyentityUtil.mc.field_71439_g.func_184187_bx() != null ? OyVeyentityUtil.mc.field_71439_g.func_184187_bx().field_70163_u : OyVeyentityUtil.mc.field_71439_g.field_70163_u, OyVeyentityUtil.mc.field_71439_g.func_184187_bx() != null ? OyVeyentityUtil.mc.field_71439_g.func_184187_bx().field_70161_v : OyVeyentityUtil.mc.field_71439_g.field_70161_v);
    }

    public static double[] forward(double speed) {
        float forward = OyVeyentityUtil.mc.field_71439_g.field_71158_b.field_192832_b;
        float side = OyVeyentityUtil.mc.field_71439_g.field_71158_b.field_78902_a;
        float yaw = OyVeyentityUtil.mc.field_71439_g.field_70126_B + (OyVeyentityUtil.mc.field_71439_g.field_70177_z - OyVeyentityUtil.mc.field_71439_g.field_70126_B) * mc.func_184121_ak();
        if (forward != 0.0f) {
            if (side > 0.0f) {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : OyVeyentityUtil.mc.field_71441_e.field_73010_i) {
            if (player.func_82150_aj() || player.func_70005_c_().equals(OyVeyentityUtil.mc.field_71439_g.func_70005_c_())) continue;
            int hpRaw = (int)OyVeyentityUtil.getHealth((Entity)player);
            ...
            healthSB.append(hp);
            int distanceInt = (int)OyVeyentityUtil.mc.field_71439_g.func_70032_d((Entity)player);
            ...
            output.put(healthSB.toString() + " " + (Banzem.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.func_70005_c_() + " " + distanceSB.toString() + " \u00c2\u00a7f0", (int)OyVeyentityUtil.mc.field_71439_g.func_70032_d((Entity)player));
