...
implements Util {
    ...
    public static void drawWaypointImage(BlockPos pos, GLUProjection.Projection projection, Color color, String name, boolean rectangle, Color rectangleColor) {
        ...
        float textWidth = Banzem.textManager.getStringWidth(text);
        Banzem.textManager.drawString(text, -(textWidth / 2.0f), -((float)Banzem.textManager.getFontHeight() / 2.0f) + (float)Banzem.textManager.getFontHeight() / 2.0f, color.getRGB(), false);
        GlStateManager.func_179137_b((double)(-projection.getX()), (double)(-projection.getY()), (double)0.0);
    ...
    public static void drawText(AxisAlignedBB pos, String text) {
        ...
        GlStateManager.func_179097_i();
        GlStateManager.func_179137_b((double)(-((double)Banzem.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
        Banzem.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.func_179121_F();
    }
    ...
    public static void drawProjectedText(GLUProjection.Projection projection, float addX, float addY, String text, Color color, boolean shadow) {
        if (projection.getType() == GLUProjection.Projection.Type.INSIDE) {
            GlStateManager.func_179094_E();
            GlStateManager.func_179137_b((double)projection.getX(), (double)projection.getY(), (double)0.0);
            Banzem.textManager.drawString(text, -((float)Banzem.textManager.getStringWidth(text) / 2.0f) + addX, addY, color.getRGB(), shadow);
            GlStateManager.func_179137_b((double)(-projection.getX()), (double)(-projection.getY()), (double)0.0);
            GlStateManager.func_179121_F();
        }
    }
    ...
    public static boolean isInViewFrustrum(AxisAlignedBB bb) {
        ...
        frustrum.func_78547_a(Objects.requireNonNull(current).field_70165_t, current.field_70163_u, current.field_70161_v);
