...
implements Util {
    ...
    public String config = "QuartzHack/config/";
    ...
    public void loadConfig(String name) {
        ...
        List files = Arrays.stream((Object[])Objects.requireNonNull(new File("QuartzHack").listFiles())).filter(File::isDirectory).collect(Collectors.toList());
        this.config = files.contains(new File("QuartzHack/" + name + "/")) ? "QuartzHack/" + name + "/" : "QuartzHack/config/";
    ...
    public void saveCurrentConfig() {
        File currentConfig = new File("QuartzHack/currentconfig.txt");
        try {
            if (currentConfig.exists()) {
                FileWriter writer = new FileWriter(currentConfig);
                String tempConfig = this.config.replaceAll("/", "");
                writer.write(tempConfig.replaceAll("QuartzHack", ""));
                writer.close();
            } else {
